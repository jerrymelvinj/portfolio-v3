export default function JsonLd() {
  const personSchema = {
    ...
    "jobTitle": "Senior Product Designer & UI/UX Specialist",
  ...
  const websiteSchema = {
    ...
    "description": "Portfolio of Jerry Melvin J, Senior Product Designer & UI/UX Specialist based in Bengaluru, India.",
    "publisher": {
      "@id": "https://www.jerrymelvinj.com/#person"
    }
  };
