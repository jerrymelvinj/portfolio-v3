      ...
      <div className="flex flex-col md:flex-row justify-between items-end gap-12">
        ...
        <div className="flex flex-col items-end gap-6">
          <div className="flex gap-4">
            <a href="#" className="w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center hover:scale-105 transition-transform">
              <span className="font-bold font-serif text-lg">Ig</span>
            </a>
            <a href="#" className="w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center hover:scale-105 transition-transform">
              <span className="font-bold font-serif text-lg">Be</span>
            </a>
            <a href="#" className="w-12 h-12 rounded-full bg-foreground text-background flex items-center justify-center hover:scale-105 transition-transform">
              <span className="font-bold font-serif text-lg">In</span>
            </a>
          </div>
